...
public class FragmentPaper extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView=view.findViewById(R.id.recyclerViewPaper);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        MyPaperAdapter myAdapter=new MyPaperAdapter(recyclerView,getContext(),new ArrayList<String>(),new ArrayList<String>());
