...
public class EmailActivity extends AppCompatActivity {
            ...
            public void onClick(View view) {
                ...
                if(!TextUtils.isEmpty(email) && !TextUtils.isEmpty(pass) & !TextUtils.isEmpty(confirm_pass)){
                    ...
                    if(pass.equals(confirm_pass)){
                        ...
                        mAuth.createUserWithEmailAndPassword(email, pass).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if(task.isSuccessful()){
                                    ...
                                    Intent setupIntent = new Intent(EmailActivity.this, FragmentSetup.class);
                                    ...
                                    Toast.makeText(EmailActivity.this, "Error : " + errorMessage, Toast.LENGTH_LONG).show();
                        ...
                        Toast.makeText(EmailActivity.this, "Confirm Password and Password Field doesn't match.", Toast.LENGTH_LONG).show();
    ...
    private void sendToMain() {
        ...
        Intent mainIntent = new Intent(EmailActivity.this, FragmentSetup.class);
