...
public class ProfilePicActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private EditText editTextName,contact, carrier;
    ...
    public void onClick(View view) {
        if (view == buttonChoose) {
            ...
            Intent i=new Intent(ProfilePicActivity.this, MainActivity.class);
            startActivity(i);
        }
    }
            ...
            sRef.putFile(filePath).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    if (task.isSuccessful()) {
                        ...
                        Uploads upload = new Uploads(editTextName.getText().toString(),contact.getText().toString(),carrier.getText().toString(),
                                downUri.toString());
